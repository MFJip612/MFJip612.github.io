...
| amazing | adj. | 令人惊讶的 |
| America | n. | 美国；美洲 |
| Ambassador (ambassadress) | n. | 大使（女大使） |
| ambulance | n. | 救护车 |
| among | prep. | 在…中间；在（三个以上）之间 |
| amount | n. & v. | 数量 |
| amusement | n. | 娱乐 |
| analyse | v. | 分析 |
| analysis | n. | 分析 (pl. analyses) |
| ancestor | n. | 祖先 |
| ancient | adj. | 古代的 |
| and | conj. | 和；又；而 |
| anger | n. | 怒，愤怒 |
...
| bar | n. | 酒吧，条，棒 |
| barbecue | n. | 烤肉 |
| bargain | n. | （经过讨价还价之后）成交的商品；廉价货 |
| bargain | v. | 讨价还价 |
| bark | v. & n. | 吠叫 |
| base | n. & v. | 根据地，基地；（棒球）垒 |
| baseball | n. | 棒球 |
| basement | n. | 地下室 |
| basic | a. | 基本的 |
| basin | n. | 水盆，脸盆 |
...
| bean | n. | 豆 |
| bear | n. | 熊 |
| bear | v. (bore, born/borne) | 负担，承担；忍受 |
| beard | n. | （下巴上的）胡须 |
| beast | n. | 野兽 |
...
| condition | n. | 条件，状况 |
| conduct | v. | 进行，管理，导电 |
| conductor | n. | 管理人员；指导者；（车上的）管理员，列车员；乐队指挥 |
| confident | adj. | 自信的 |
| conference | n. | 会议 |
| confirm | v. | 证实，确认 |
| confuse | v. | 使迷惑 |
...
| demand | vt. | 要求 |
| dentist | n. | 牙科医生 |
| department (缩 Dept.) | n. | 部门；（机关的）司，处；（大学的）系 |
...
| dinosaur | n. | 恐龙 |
| dip | vt. | 浸，蘸；把……放入又取出 |
| direct | a. | 直接的；直达的；直截了当的 |
| direct | vt. | 指挥；指导；监督；管理；指挥（演奏）；导演（电影） |
| direction | n. | 方向；方位 |
...
| division | n. | （算术用语）除 |
| divorce | v. | 离婚 |
| do (did, done) | v. & aux. | 做，干（用以构成疑问句及否定句。第三人称单数现在时用 does） |
| don't = do not | v. & aux. | 不做，不干 |
| doctor | n. | 医生，大夫；博士 |
| document | n. | 文件；文献 |
| dog | n. | 狗 |
| doll | n. | 玩偶，玩具娃娃 |
...
| dustbin | n. | 垃圾箱 |
| duty | n. | 责任，义务 |
| DVD | n. | 数码影碟 (digital versatile disk) |
...
| field | n. | 田地；牧场；场地 |
| fierce | a. | 猛烈的 |
| fight (fought, fought) | v. & n. | 打仗（架），与……打架（仗）；争论 |
...
| how | ad. | 怎样，如何；多少；多么 |
| however | ad. | 可是 |
| however | conj. | 然而，可是，尽管如此 |
| hug | v. | 拥抱 |
| huge | a. | 巨大的，庞大的 |
| human | a. | 人的，人类的 |
| human being | n. | 人 |
| humorous | a. | 富于幽默的 |
| humour (美 humor) | n. | 幽默，幽默感 |
| hunger | n. | 饥饿 |
| hungry | a. | （饥）饿的 |
| hunt | vt. | 寻找；狩猎，猎取 |
| hunter | n. | 猎人 |
...
| middle | n. | 中间；当中；中级的 |
| midnight | n. | 午夜 |
| might | v. aux. | (may 的过去式，助动词)可能，也许 |
| mild | a. | 温和的，暖和的，凉爽的 |
| mile | n. | 英里 |
| milk | n. | 牛奶 |
| milk | vt. | 挤奶 |
...
| soup | n. | 汤 |
| sour | a. | 酸的 |
| south | a. | 南(方)的；向南的；从南来的 |
| south | ad. | 在南方；向南方；自南方 |
| south | n. | 南；南方；南风；南部 |
| southeast | n. | 东南 |
| southern | a. | 南部的，南方的 |
| southwest | n. | 西南 |
...
| spirit | n. | 精神 |
| spit | v. | 吐唾沫；吐痰 (spit, spit) |
| splendid | a. | 灿烂的，辉煌的；（口语）极好的 |
| spoken | a. | 口语的 |
| spokesman/spokeswoman | n. | 发言人/女发言人 |
| spoon | n. | 匙，调羹 |
| sport | n. | 体育运动，锻炼；（复，英）运动会 |
| spot | n. | 斑点，污点；场所，地点 |
| spot | v. | 沾上污渍 |
| spread | v. | 延伸；展开 (spread, spread) |
| spring | n. | 春天，春季 |
| spring | n. | 泉水，泉 |
| spy | n. | 密探，间谍 |
| spy | v. | 侦探，刺探 |
| square | n. | 广场 |
| square | a. | 平方的；方形的，宽而结实的 |
| squirrel | n. | 松鼠 |
| stadium | n. | （露天）体育场 |
| stage | n. | 舞台；阶段 |
| stair | n. | 楼梯 |
...
| sweet | n. | 甜食；蜜饯；甜点；糖果；芳香 |
| sweet | a. | 甜的；可爱的 |
| swell (swelled, swollen) | v. | 膨胀，隆起 |
| swim | n. | 游泳，游 |
...
| underground | a. | 地下的 |
| underground | n. | 地铁 |
| understand (understood, understood) | v. | 懂得；明白 |
| unfair | a. | 不公平的，不公正的 |
| uniform | n. | 制服 |
| unit | n. | 单元，单位 |
| universe | n. | 宇宙 |
...
| warm | a. | 暖和的,温暖的;热情的 |
| warn | v. | 警告，预先通知 |
| wash | n. | 洗(涤)冲洗,洗剂,泼溅,洗的衣服 |
| wash | v. | 洗(涤), |
| washroom | n. | 盥洗室 |
| waste | n. & vt. | 浪费 |
| watch | vt. | 观看,注视;当心,注意 |
| watch | n. | 手表,表 |
| water | n. | 水 |
| water | v. | 浇水 |
| watermelon | n. | 西瓜 |
...
| wherever | conj. | 无论在哪里 |
| whether | conj. | 是否 |
| which | pron. | 那(哪)一个;那(哪)一些 |
| which | a. | 这(哪)个; |
| whichever | pron. | 无论哪个;无论哪些 |
| while | conj. | 在…的时候和…同时 |
| while | n. | 一会儿, |
| whisper | v. | 低语,私下说 |
| whistle | n. | 口哨 |
| white | a. | 白色的 |
...
| whom | pron. | (who 的宾格 ) |
| whose | pron. | 谁的 |
| why | ad./int. | 为什么，你难道不知道 |
| wide | a. | 宽阔的 |
| widespread | a. | 广泛的 |
| wife | n. | 妻子 |
| wild | a. | 未开发的，荒凉的；野生的，野的 |
| wildlife | n. | 野生动物 |
| will | n. | 意志，遗嘱 |
...
| burden | n. | 负担，担子 |
| burst | v. | 爆裂，诈破 |
| campaign | n. | 战役，（政治或商业）活动 |
| cell | n. | 单元，蜂房 |
| circumstance | n. | 环境，情况 |
| collection | n. | 收藏，征收 |
| combine | v. | （使）联合，（使）结合 |
| command | n. & v. | 命令，掌握，支配 |
...
| rough | a. | 粗糙的 |
| security | n. | 安全 |
| seek (sought, sought) | v. | 寻找，探寻 |
| severe | a. | 严厉的，严重的 |
| slide (slid, slid/slidden) | v. | 滑动 |
| slide | n. | 滑行，幻灯片 |
| slip | n. | 滑倒 |
| staff | n. | 全体职员 |
| steady | a. | 稳定的，坚定的 |
| strength | n. | 力量，力气 |
| strike (struck, struck/stricken) | v. & n. | 撞击，罢工 |
| style | n. | 风格，类型 |
| surround | v. | 围绕 |
| swing (swung, swung) | v. | 摇摆，旋转 |
| swing | n. | 秋千，摇摆 |
| sympathy | n. | 同情心 |
| talent | n. | 天才，才干 |
| tax | n. | 税 |
